...
namespace LoftyRoomsDAL.Migrations
{
    ...
    [Migration("20230809062053_2023080902")]
    partial class _2023080902
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoftyRoomsModel.Administration.AdminWalletAmount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LoftyRoomsModel.Ads.FavouriteAd", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LoftyRoomsModel.Bookings.BookingRatingAndReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BookingRatingAndReviews");
                });

            modelBuilder.Entity("LoftyRoomsModel.Bookings.Inquiry", b =>
                {
                    ...
                    b.Property<int?>("CustomerWalletAmountsId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("VoucherValidTillDate")
                        .HasColumnType("longtext");

                    b.Property<string>("X_API_KEY")
                        .HasColumnType("longtext");
                    ...
                    b.HasIndex("CustomerWalletAmountsId");
            ...
            modelBuilder.Entity("LoftyRoomsModel.Customers.Customer", b =>
                {
                    ...
                    b.Property<string>("AndroidFcmToken")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("LoftyRoomsModel.Customers.CustomerFireBaseNotification", b =>
                {
                    b.Property<int>("NotificationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CustomerFireBaseNotifications");
                });

            modelBuilder.Entity("LoftyRoomsModel.Customers.CustomerHelpSupport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CustomerHelpSupports");
                });

            modelBuilder.Entity("LoftyRoomsModel.Customers.CustomerRatingAndReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CustomerRatingAndReviews");
                });
            ...
            modelBuilder.Entity("LoftyRoomsModel.Customers.CustomerWalletHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CustomerWalletHistory");
                });

            modelBuilder.Entity("LoftyRoomsModel.Customers.CustomerWalletHistoryForPayit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CustomerWalletHistoryForPayit");
                });
            ...
            modelBuilder.Entity("LoftyRoomsModel.Partners.PartnerFireBaseNotification", b =>
                {
                    b.Property<int>("NotificationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PartnerFireBaseNotifications");
                });

            modelBuilder.Entity("LoftyRoomsModel.Partners.PartnerNotification", b =>
                {
                    b.Property<int>("NotificationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PartnerNotifications");
                });
            ...
            modelBuilder.Entity("LoftyRoomsModel.Partners.PartnerWalletHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PartnerWalletHistory");
                });
            ...
            modelBuilder.Entity("LoftyRoomsModel.Bookings.BookingRatingAndReview", b =>
                {
                    b.HasOne("LoftyRoomsModel.Bookings.Booking", "Bookings")
                        .WithMany()
            ...
            modelBuilder.Entity("LoftyRoomsModel.Bookings.Inquiry", b =>
                {
                    ...
                    b.HasOne("LoftyRoomsModel.Customers.CustomerWalletAmount", "CustomerWalletAmounts")
                        .WithMany()
                        .HasForeignKey("CustomerWalletAmountsId");

                    b.Navigation("Bookings");

                    b.Navigation("CustomerWalletAmounts");
                });
